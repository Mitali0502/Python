...
image_no_1 = ImageTk.PhotoImage(Image.open("D:\c++\python\images\IMG_9636.jpg"))
image_no_2 = ImageTk.PhotoImage(Image.open("D:\c++\python\images\IMG_9637.jpg"))
image_no_3 = ImageTk.PhotoImage(Image.open("D:\c++\python\images\IMG_9638.jpg"))
image_no_4 = ImageTk.PhotoImage(Image.open("D:\c++\python\images\IMG_9639.jpg"))
...
button_back = Button(root, text="Back", command=lambda: back(4),
					#state=DISABLED
                    )
